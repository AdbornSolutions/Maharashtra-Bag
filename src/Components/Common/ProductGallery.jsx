  ...
  return (
    <>
      <section className="bg-[#f6f5ed] px-2 pb-4 sm:px-[15px] sm:pb-[15px]" aria-labelledby={`${productType}-products-heading`}>
        <div className="mx-auto max-w-[1410px] rounded-[20px] bg-white px-5 py-12 sm:px-10 sm:py-14 lg:px-[66px] lg:py-[70px]">
          <div className="text-center">
            ...
            <h2 id={`${productType}-products-heading`} className="mx-auto mt-4 max-w-[650px] text-[32px] font-bold leading-[1.05] text-[#202d42] sm:text-[43px] lg:text-[48px]">
              {heading}
            </h2>
            <p className="mt-4 text-sm text-[#657083]">Explore our complete collection of {products.length} {productType} bag designs.</p>
          </div>

          <div className="mt-7 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:mt-8 lg:grid-cols-4">
              ...
              >
                ...
                <span className="absolute inset-x-0 bottom-0 flex items-end justify-between gap-3 px-5 pb-5 text-white">
                  <span className="min-w-0">
                    <span className="block max-w-[190px] text-[16px] font-medium leading-[1.2]">{product.title}</span>
                    <span className="mt-2 block max-w-[180px] text-[10px] leading-[1.45] text-white/75">{product.description}</span>
                  </span>
