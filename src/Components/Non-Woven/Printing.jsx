...
const Printing = () => (
  <section className="bg-[#f6f5ed] px-2 pb-4 sm:px-[15px] sm:pb-[15px]" aria-labelledby="printing-heading">
    <div className="mx-auto grid w-full max-w-[1880px] items-start gap-14 rounded-[20px] bg-white px-6 py-14 sm:px-[4%] md:grid-cols-[1.05fr_.95fr] lg:gap-[clamp(60px,6vw,115px)] lg:py-[clamp(60px,5vw,92px)]">
      <div>
        ...
        <h2 id="printing-heading" className="mt-6 max-w-[850px] text-[clamp(35px,8vw,46px)] font-bold leading-[1.06] text-[#202d42] md:text-[clamp(42px,3.2vw,62px)]">
        ...
        <div className="mt-12 border-t border-[#d9dee6]">
          {printingMethods.map((method, index) => (
            <article key={method.title} className="grid gap-2 border-b border-[#d9dee6] py-5 sm:grid-cols-[32px_minmax(135px,190px)_1fr] sm:items-start sm:gap-4">
      ...
      <div className="mx-auto w-full max-w-[760px] md:justify-self-end">
        <img src={printingImage} alt="Screen printing a branded non-woven bag by hand" className="h-auto w-full rounded-[20px] object-contain" />
      </div>
    </div>
  </section>
)
