...
const Hero = () => (
  <section className="bg-[#f6f5ed] px-2 py-2 sm:px-[1%] sm:py-2.5" aria-labelledby="non-woven-hero-title">
    <div className="mx-auto w-full max-w-[1880px] overflow-hidden rounded-[20px] bg-white">
      ...
      <div className="mx-auto grid w-full max-w-[1800px] gap-10 px-6 pb-12 pt-12 sm:px-[4%] md:grid-cols-[1.05fr_.95fr] md:items-center lg:min-h-[clamp(680px,48vw,860px)] lg:gap-[clamp(56px,6vw,115px)] lg:pb-[clamp(54px,4vw,74px)] lg:pt-[clamp(44px,3vw,64px)]">
        <div>
          <h1 id="non-woven-hero-title" className="max-w-[850px] text-[clamp(40px,10vw,52px)] font-bold leading-[1.06] text-[#1c3158] md:text-[clamp(46px,3.8vw,72px)]">
            Premium Non-Woven Bags for Sustainable &amp; Cost-Effective Packaging
          </h1>
          <p className="mt-8 max-w-[760px] text-[clamp(13px,.9vw,16px)] leading-[1.7] text-[#71809b]">
            Maharashtra Bag manufactures high-quality Non-Woven Bags that combine durability, affordability, and sustainability. Designed for retail, supermarkets, corporate branding, promotional campaigns, and bulk packaging, our bags offer a reliable and eco-friendly alternative to single-use plastic.
          </p>
        ...
        <div className="mx-auto w-full max-w-[760px] md:justify-self-end">
          <img src={heroProduct} alt="Premium sustainable non-woven shopping bag" className="h-auto w-full rounded-[20px] object-cover" />
        </div>
      </div>
    </div>
  </section>
