...
const Strenght = () => (
  <section className="bg-[#f6f5ed] px-5 py-16 sm:px-10 lg:px-[5.3%] lg:py-[82px]" aria-labelledby="non-woven-strength-heading">
    <div className="mx-auto grid max-w-[1260px] items-center gap-14 lg:grid-cols-[.88fr_1.12fr] lg:gap-[96px]">
      ...
      <div>
        ...
        <h2 id="non-woven-strength-heading" className="mt-5 max-w-[650px] text-[37px] font-bold leading-[1.04] text-[#1c3158] sm:text-[46px] lg:text-[50px]">
