...
const Strenght = () => (
  <section className="bg-[#f6f5ed] px-5 py-14 sm:px-[4%] sm:py-16 lg:py-[clamp(72px,7vw,120px)]" aria-labelledby="jute-strength-heading">
    <div className="mx-auto grid w-full max-w-[1800px] items-center gap-14 md:grid-cols-[.88fr_1.12fr] lg:gap-[clamp(60px,7vw,130px)]">
      ...
      <div>
        ...
        <h2 id="jute-strength-heading" className="mt-5 max-w-[850px] text-[clamp(35px,8vw,46px)] font-bold leading-[1.04] text-[#1c3158] md:text-[clamp(42px,3.2vw,62px)]">
